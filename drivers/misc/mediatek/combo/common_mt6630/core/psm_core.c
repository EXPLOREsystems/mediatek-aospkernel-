...
#define STP_PSM_LOUD_FUNC(fmt, arg...)   if (gPsmDbgLevel >= STP_PSM_LOG_LOUD) { printk(KERN_DEBUG PFX_PSM "%s: "  fmt, __func__ , ##arg); }
#define STP_PSM_DBG_FUNC(fmt, arg...)    if (gPsmDbgLevel >= STP_PSM_LOG_DBG) {  printk(KERN_DEBUG PFX_PSM "%s: "  fmt, __func__ , ##arg); }
#define STP_PSM_INFO_FUNC(fmt, arg...)   if (gPsmDbgLevel >= STP_PSM_LOG_INFO) { printk(PFX_PSM "[I]%s: "  fmt, __func__ , ##arg); }
#define STP_PSM_WARN_FUNC(fmt, arg...)   if (gPsmDbgLevel >= STP_PSM_LOG_WARN) { printk(PFX_PSM "[W]%s: "  fmt, __func__ , ##arg); }
#define STP_PSM_ERR_FUNC(fmt, arg...)    if (gPsmDbgLevel >= STP_PSM_LOG_ERR) {  printk(PFX_PSM "[E]%s(%d):ERROR! "   fmt, __func__ , __LINE__, ##arg); }
