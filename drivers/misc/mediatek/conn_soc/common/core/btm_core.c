...
#define STP_BTM_LOUD_FUNC(fmt, arg...)   if (gBtmDbgLevel >= STP_BTM_LOG_LOUD) { printk(KERN_DEBUG PFX_BTM "%s: "  fmt, __func__ , ##arg); }
#define STP_BTM_DBG_FUNC(fmt, arg...)    if (gBtmDbgLevel >= STP_BTM_LOG_DBG) { printk(KERN_DEBUG PFX_BTM "%s: "  fmt, __func__ , ##arg); }
#define STP_BTM_INFO_FUNC(fmt, arg...)   if (gBtmDbgLevel >= STP_BTM_LOG_INFO) { printk(PFX_BTM "[I]%s: "  fmt, __func__ , ##arg); }
#define STP_BTM_WARN_FUNC(fmt, arg...)   if (gBtmDbgLevel >= STP_BTM_LOG_WARN) { printk(PFX_BTM "[W]%s: "  fmt, __func__ , ##arg); }
#define STP_BTM_ERR_FUNC(fmt, arg...)    if (gBtmDbgLevel >= STP_BTM_LOG_ERR) {  printk(PFX_BTM "[E]%s(%d):ERROR! "   fmt, __func__ , __LINE__, ##arg); }
