...
static INT32 mtk_wcn_soc_set_sdio_driving(void)
{
    ...
    sdio_driving_table[0].cmd[12] = (UCHAR)((drv_val & 0x00000077UL) >> 0);
    sdio_driving_table[0].cmd[13] = (UCHAR)((drv_val & 0x00007700UL) >> 8);
    sdio_driving_table[0].cmd[14] = (UCHAR)((drv_val & 0x00070000UL) >> 16);
