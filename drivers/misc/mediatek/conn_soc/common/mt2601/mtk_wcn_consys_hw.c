...
INT32 mtk_wcn_consys_hw_reg_ctrl(UINT32 on, UINT32 co_clock_en)
{
	...
	if (on)
	{
		...
		/*12.poll CONSYS CHIP until MT6582/MT6572/MT2601 is returned, <CONSYS_CHIP_ID_REG>, 32'h6582/32'h6572 */
		...
		while (retry-- > 0)
		{
			...
			if ((consysHwChipId == 0x6582) || (consysHwChipId == 0x6572) || (consysHwChipId == 0x2601))
			{
