...
#define BLS_DBG(string, args...) if (bls_dbg_log) printk("[BLS]"string, ##args)
#define BLS_MSG(string, args...) printk("[BLS]"string, ##args)
#define BLS_ERR(string, args...) printk("[BLS]error:"string, ##args)
