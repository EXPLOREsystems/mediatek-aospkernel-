...
static int AudDrv_Read_Procmem(struct seq_file *buf, void *v)
{
    ...
    len += seq_printf(buf+len , "Afe_Mem_Pwr_on =0x%x\n", Afe_Mem_Pwr_on);
    len += seq_printf(buf+len , "Aud_AFE_Clk_cntr = 0x%x\n", Aud_AFE_Clk_cntr);
    len += seq_printf(buf+len , "Aud_ANA_Clk_cntr = 0x%x\n", Aud_ANA_Clk_cntr);
    len += seq_printf(buf+len , "Aud_HDMI_Clk_cntr = 0x%x\n", Aud_HDMI_Clk_cntr);
    len += seq_printf(buf+len , "Aud_I2S_Clk_cntr = 0x%x\n", Aud_I2S_Clk_cntr);
    len += seq_printf(buf+len , "Aud_Int_Mem_Flag = 0x%x\n", Aud_Int_Mem_Flag);
    len += seq_printf(buf+len , "Aud_Ext_Mem_Flag = 0x%x\n", Aud_Ext_Mem_Flag);
    len += seq_printf(buf+len , "AuddrvSpkStatus = 0x%x\n", AuddrvSpkStatus);

    len += seq_printf(buf+len , "AUDIO_TOP_CON0  = 0x%x\n", Afe_Get_Reg(AUDIO_AFE_TOP_CON0));
    len += seq_printf(buf+len , "AUDIO_TOP_CON1  = 0x%x\n", Afe_Get_Reg(AUDIO_AFE_TOP_CON1));
    len += seq_printf(buf+len , "AUDIO_TOP_CON2  = 0x%x\n", Afe_Get_Reg(AUDIO_AFE_TOP_CON2));
    len += seq_printf(buf+len , "AUDIO_TOP_CON3  = 0x%x\n", Afe_Get_Reg(AUDIO_AFE_TOP_CON3));
    len += seq_printf(buf+len , "AFE_DAC_CON0  = 0x%x\n", Afe_Get_Reg(AFE_DAC_CON0));
    len += seq_printf(buf+len , "AFE_DAC_CON1  = 0x%x\n", Afe_Get_Reg(AFE_DAC_CON1));
    len += seq_printf(buf+len , "AFE_I2S_CON  = 0x%x\n", Afe_Get_Reg(AFE_I2S_CON));
    len += seq_printf(buf+len , "AFE_CONN0  = 0x%x\n", Afe_Get_Reg(AFE_CONN0));
    len += seq_printf(buf+len , "AFE_CONN1  = 0x%x\n", Afe_Get_Reg(AFE_CONN1));
    len += seq_printf(buf+len , "AFE_CONN2  = 0x%x\n", Afe_Get_Reg(AFE_CONN2));
    len += seq_printf(buf+len , "AFE_CONN3  = 0x%x\n", Afe_Get_Reg(AFE_CONN3));
    len += seq_printf(buf+len , "AFE_CONN4  = 0x%x\n", Afe_Get_Reg(AFE_CONN4));
    len += seq_printf(buf+len , "AFE_I2S_CON1  = 0x%x\n", Afe_Get_Reg(AFE_I2S_CON1));
    len += seq_printf(buf+len , "AFE_I2S_CON2  = 0x%x\n", Afe_Get_Reg(AFE_I2S_CON2));
    len += seq_printf(buf+len , "AFE_I2S_CON3  = 0x%x\n", Afe_Get_Reg(AFE_I2S_CON3));

    len += seq_printf(buf+len , "AFE_DL1_BASE  = 0x%x\n", Afe_Get_Reg(AFE_DL1_BASE));
    len += seq_printf(buf+len , "AFE_DL1_CUR  = 0x%x\n", Afe_Get_Reg(AFE_DL1_CUR));
    len += seq_printf(buf+len , "AFE_DL1_END  = 0x%x\n", Afe_Get_Reg(AFE_DL1_END));
    len += seq_printf(buf+len , "AFE_DL2_BASE  = 0x%x\n", Afe_Get_Reg(AFE_DL2_BASE));
    len += seq_printf(buf+len , "AFE_DL2_CUR  = 0x%x\n", Afe_Get_Reg(AFE_DL2_CUR));
    len += seq_printf(buf+len , "AFE_DL2_END  = 0x%x\n", Afe_Get_Reg(AFE_DL2_END));
    len += seq_printf(buf+len , "AFE_AWB_BASE  = 0x%x\n", Afe_Get_Reg(AFE_AWB_BASE));
    len += seq_printf(buf+len , "AFE_AWB_END  = 0x%x\n", Afe_Get_Reg(AFE_AWB_END));
    len += seq_printf(buf+len , "AFE_AWB_CUR  = 0x%x\n", Afe_Get_Reg(AFE_AWB_CUR));
    len += seq_printf(buf+len , "AFE_VUL_BASE  = 0x%x\n", Afe_Get_Reg(AFE_VUL_BASE));
    len += seq_printf(buf+len , "AFE_VUL_END  = 0x%x\n", Afe_Get_Reg(AFE_VUL_END));
    len += seq_printf(buf+len , "AFE_VUL_CUR  = 0x%x\n", Afe_Get_Reg(AFE_VUL_CUR));

    len += seq_printf(buf+len , "AFE_MEMIF_MON0  = 0x%x\n", Afe_Get_Reg(AFE_MEMIF_MON0));
    len += seq_printf(buf+len , "AFE_MEMIF_MON1  = 0x%x\n", Afe_Get_Reg(AFE_MEMIF_MON1));
    len += seq_printf(buf+len , "AFE_MEMIF_MON2  = 0x%x\n", Afe_Get_Reg(AFE_MEMIF_MON2));
    len += seq_printf(buf+len , "AFE_MEMIF_MON4  = 0x%x\n", Afe_Get_Reg(AFE_MEMIF_MON4));

    len += seq_printf(buf+len , "AFE_ADDA_DL_SRC2_CON0  = 0x%x\n", Afe_Get_Reg(AFE_ADDA_DL_SRC2_CON0));
    len += seq_printf(buf+len , "AFE_ADDA_DL_SRC2_CON1  = 0x%x\n", Afe_Get_Reg(AFE_ADDA_DL_SRC2_CON1));
    len += seq_printf(buf+len , "AFE_ADDA_UL_SRC_CON0  = 0x%x\n", Afe_Get_Reg(AFE_ADDA_UL_SRC_CON0));
    len += seq_printf(buf+len , "AFE_ADDA_UL_SRC_CON1  = 0x%x\n", Afe_Get_Reg(AFE_ADDA_UL_SRC_CON1));
    len += seq_printf(buf+len , "AFE_ADDA_TOP_CON0  = 0x%x\n", Afe_Get_Reg(AFE_ADDA_TOP_CON0));
    len += seq_printf(buf+len , "AFE_ADDA_UL_DL_CON0  = 0x%x\n", Afe_Get_Reg(AFE_ADDA_UL_DL_CON0));
    len += seq_printf(buf+len , "AFE_ADDA_SRC_DEBUG  = 0x%x\n", Afe_Get_Reg(AFE_ADDA_SRC_DEBUG));
    len += seq_printf(buf+len , "AFE_ADDA_SRC_DEBUG_MON0  = 0x%x\n", Afe_Get_Reg(AFE_ADDA_SRC_DEBUG_MON0));
    len += seq_printf(buf+len , "AFE_ADDA_SRC_DEBUG_MON1  = 0x%x\n", Afe_Get_Reg(AFE_ADDA_SRC_DEBUG_MON1));
    len += seq_printf(buf+len , "AFE_ADDA_NEWIF_CFG0  = 0x%x\n", Afe_Get_Reg(AFE_ADDA_NEWIF_CFG0));
    len += seq_printf(buf+len , "AFE_ADDA_NEWIF_CFG1  = 0x%x\n", Afe_Get_Reg(AFE_ADDA_NEWIF_CFG1));

    len += seq_printf(buf+len , "AFE_SIDETONE_DEBUG  = 0x%x\n", Afe_Get_Reg(AFE_SIDETONE_DEBUG));
    len += seq_printf(buf+len , "AFE_SIDETONE_MON  = 0x%x\n", Afe_Get_Reg(AFE_SIDETONE_MON));
    len += seq_printf(buf+len , "AFE_SIDETONE_CON0  = 0x%x\n", Afe_Get_Reg(AFE_SIDETONE_CON0));
    len += seq_printf(buf+len , "AFE_SIDETONE_COEFF  = 0x%x\n", Afe_Get_Reg(AFE_SIDETONE_COEFF));
    len += seq_printf(buf+len , "AFE_SIDETONE_CON1  = 0x%x\n", Afe_Get_Reg(AFE_SIDETONE_CON1));
    len += seq_printf(buf+len , "AFE_SIDETONE_GAIN  = 0x%x\n", Afe_Get_Reg(AFE_SIDETONE_GAIN));
    len += seq_printf(buf+len , "AFE_SGEN_CON0  = 0x%x\n", Afe_Get_Reg(AFE_SGEN_CON0));

    len += seq_printf(buf+len , "AFE_TOP_CON0  = 0x%x\n", Afe_Get_Reg(AFE_TOP_CON0));
    len += seq_printf(buf+len , "AFE_ADDA_PREDIS_CON0  = 0x%x\n", Afe_Get_Reg(AFE_ADDA_PREDIS_CON0));
    len += seq_printf(buf+len , "AFE_ADDA_PREDIS_CON1  = 0x%x\n", Afe_Get_Reg(AFE_ADDA_PREDIS_CON1));

    len += seq_printf(buf+len , "AFE_IRQ_CON  = 0x%x\n", Afe_Get_Reg(AFE_IRQ_CON));
    len += seq_printf(buf+len , "AFE_IRQ_STATUS  = 0x%x\n", Afe_Get_Reg(AFE_IRQ_STATUS));
    len += seq_printf(buf+len , "AFE_IRQ_CLR  = 0x%x\n", Afe_Get_Reg(AFE_IRQ_CLR));
    len += seq_printf(buf+len , "AFE_IRQ_CNT1  = 0x%x\n", Afe_Get_Reg(AFE_IRQ_CNT1));
    len += seq_printf(buf+len , "AFE_IRQ_CNT2  = 0x%x\n", Afe_Get_Reg(AFE_IRQ_CNT2));
    len += seq_printf(buf+len , "AFE_IRQ_MON2  = 0x%x\n", Afe_Get_Reg(AFE_IRQ_MON2));
    len += seq_printf(buf+len , "AFE_IRQ1_CNT_MON  = 0x%x\n", Afe_Get_Reg(AFE_IRQ1_CNT_MON));
    len += seq_printf(buf+len , "AFE_IRQ2_CNT_MON  = 0x%x\n", Afe_Get_Reg(AFE_IRQ2_CNT_MON));
    len += seq_printf(buf+len , "AFE_IRQ1_EN_CNT_MON  = 0x%x\n", Afe_Get_Reg(AFE_IRQ1_EN_CNT_MON));

    len += seq_printf(buf+len , "AFE_MEMIF_MAXLEN  = 0x%x\n", Afe_Get_Reg(AFE_MEMIF_MAXLEN));

    len += seq_printf(buf+len , "AFE_GAIN1_CON0  = 0x%x\n", Afe_Get_Reg(AFE_GAIN1_CON0));
    len += seq_printf(buf+len , "AFE_GAIN1_CON1  = 0x%x\n", Afe_Get_Reg(AFE_GAIN1_CON1));
    len += seq_printf(buf+len , "AFE_GAIN1_CON2  = 0x%x\n", Afe_Get_Reg(AFE_GAIN1_CON2));
    len += seq_printf(buf+len , "AFE_GAIN1_CON3  = 0x%x\n", Afe_Get_Reg(AFE_GAIN1_CON3));
    len += seq_printf(buf+len , "AFE_GAIN1_CONN  = 0x%x\n", Afe_Get_Reg(AFE_GAIN1_CONN));
    len += seq_printf(buf+len , "AFE_GAIN1_CUR  = 0x%x\n", Afe_Get_Reg(AFE_GAIN1_CUR));

    len += seq_printf(buf+len , "AFE_GAIN2_CON0  = 0x%x\n", Afe_Get_Reg(AFE_GAIN2_CON0));
    len += seq_printf(buf+len , "AFE_GAIN2_CON1  = 0x%x\n", Afe_Get_Reg(AFE_GAIN2_CON1));
    len += seq_printf(buf+len , "AFE_GAIN2_CON2  = 0x%x\n", Afe_Get_Reg(AFE_GAIN2_CON2));
    len += seq_printf(buf+len , "AFE_GAIN2_CON3  = 0x%x\n", Afe_Get_Reg(AFE_GAIN2_CON3));
    len += seq_printf(buf+len , "AFE_GAIN2_CONN  = 0x%x\n", Afe_Get_Reg(AFE_GAIN2_CONN));
    len += seq_printf(buf+len , "AFE_GAIN2_CONN2  = 0x%x\n", Afe_Get_Reg(AFE_GAIN2_CONN2));
    len += seq_printf(buf+len , "AFE_GAIN2_CUR  = 0x%x\n", Afe_Get_Reg(AFE_GAIN2_CUR));

    len += seq_printf(buf+len , "FPGA_CFG0  = 0x%x\n", Afe_Get_Reg(FPGA_CFG0));
    len += seq_printf(buf+len , "FPGA_CFG1  = 0x%x\n", Afe_Get_Reg(FPGA_CFG1));

    len += seq_printf(buf+len , "AFE_ASRC_CON0  = 0x%x\n", Afe_Get_Reg(AFE_ASRC_CON0));
    len += seq_printf(buf+len , "AFE_ASRC_CON1  = 0x%x\n", Afe_Get_Reg(AFE_ASRC_CON1));
    len += seq_printf(buf+len , "AFE_ASRC_CON2  = 0x%x\n", Afe_Get_Reg(AFE_ASRC_CON2));
    len += seq_printf(buf+len , "AFE_ASRC_CON3  = 0x%x\n", Afe_Get_Reg(AFE_ASRC_CON3));
    len += seq_printf(buf+len , "AFE_ASRC_CON4  = 0x%x\n", Afe_Get_Reg(AFE_ASRC_CON4));
    len += seq_printf(buf+len , "AFE_ASRC_CON5  = 0x%x\n", Afe_Get_Reg(AFE_ASRC_CON5));
    len += seq_printf(buf+len , "AFE_ASRC_CON6  = 0x%x\n", Afe_Get_Reg(AFE_ASRC_CON6));
    len += seq_printf(buf+len , "AFE_ASRC_CON7  = 0x%x\n", Afe_Get_Reg(AFE_ASRC_CON7));
    len += seq_printf(buf+len , "AFE_ASRC_CON8  = 0x%x\n", Afe_Get_Reg(AFE_ASRC_CON8));
    len += seq_printf(buf+len , "AFE_ASRC_CON9  = 0x%x\n", Afe_Get_Reg(AFE_ASRC_CON9));
    len += seq_printf(buf+len , "AFE_ASRC_CON10 = 0x%x\n", Afe_Get_Reg(AFE_ASRC_CON10));
    len += seq_printf(buf+len , "AFE_ASRC_CON11 = 0x%x\n", Afe_Get_Reg(AFE_ASRC_CON11));

    len += seq_printf(buf+len , "PCM2_INTF_CON  = 0x%x\n", Afe_Get_Reg(PCM2_INTF_CON));

    len += seq_printf(buf+len , "AFE_ASRC_CON13  = 0x%x\n", Afe_Get_Reg(AFE_ASRC_CON13));
    len += seq_printf(buf+len , "AFE_ASRC_CON14  = 0x%x\n", Afe_Get_Reg(AFE_ASRC_CON14));
    len += seq_printf(buf+len , "AFE_ASRC_CON15  = 0x%x\n", Afe_Get_Reg(AFE_ASRC_CON15));
    len += seq_printf(buf+len , "AFE_ASRC_CON16  = 0x%x\n", Afe_Get_Reg(AFE_ASRC_CON16));
    len += seq_printf(buf+len , "AFE_ASRC_CON17  = 0x%x\n", Afe_Get_Reg(AFE_ASRC_CON17));
    len += seq_printf(buf+len , "AFE_ASRC_CON18  = 0x%x\n", Afe_Get_Reg(AFE_ASRC_CON18));
    len += seq_printf(buf+len , "AFE_ASRC_CON19  = 0x%x\n", Afe_Get_Reg(AFE_ASRC_CON19));
    len += seq_printf(buf+len , "AFE_ASRC_CON20  = 0x%x\n", Afe_Get_Reg(AFE_ASRC_CON20));
    len += seq_printf(buf+len , "AFE_ASRC_CON21  = 0x%x\n", Afe_Get_Reg(AFE_ASRC_CON21));

    len += seq_printf(buf+len , "ABB_AFE_CON0  = 0x%x\n", Ana_Get_Reg(ABB_AFE_CON0));
    len += seq_printf(buf+len , "ABB_AFE_CON1  = 0x%x\n", Ana_Get_Reg(ABB_AFE_CON1));
    len += seq_printf(buf+len , "ABB_AFE_CON2  = 0x%x\n", Ana_Get_Reg(ABB_AFE_CON2));
    len += seq_printf(buf+len , "ABB_AFE_CON3  = 0x%x\n", Ana_Get_Reg(ABB_AFE_CON3));
    len += seq_printf(buf+len , "ABB_AFE_CON4  = 0x%x\n", Ana_Get_Reg(ABB_AFE_CON4));
    len += seq_printf(buf+len , "ABB_AFE_CON5  = 0x%x\n", Ana_Get_Reg(ABB_AFE_CON5));
    len += seq_printf(buf+len , "ABB_AFE_CON6  = 0x%x\n", Ana_Get_Reg(ABB_AFE_CON6));
    len += seq_printf(buf+len , "ABB_AFE_CON7  = 0x%x\n", Ana_Get_Reg(ABB_AFE_CON7));
    len += seq_printf(buf+len , "ABB_AFE_CON8  = 0x%x\n", Ana_Get_Reg(ABB_AFE_CON8));
    len += seq_printf(buf+len , "ABB_AFE_CON9  = 0x%x\n", Ana_Get_Reg(ABB_AFE_CON9));
    len += seq_printf(buf+len , "ABB_AFE_CON10 = 0x%x\n", Ana_Get_Reg(ABB_AFE_CON10));
    len += seq_printf(buf+len , "ABB_AFE_CON11 = 0x%x\n", Ana_Get_Reg(ABB_AFE_CON11));

    len += seq_printf(buf+len , "ABB_AFE_STA0  = 0x%x\n", Ana_Get_Reg(ABB_AFE_STA0));
    len += seq_printf(buf+len , "ABB_AFE_STA1  = 0x%x\n", Ana_Get_Reg(ABB_AFE_STA1));
    len += seq_printf(buf+len , "ABB_AFE_STA2  = 0x%x\n", Ana_Get_Reg(ABB_AFE_STA2));

    len += seq_printf(buf+len , "AFE_UP8X_FIFO_CFG0  = 0x%x\n", Ana_Get_Reg(AFE_UP8X_FIFO_CFG0));
    len += seq_printf(buf+len , "AFE_UP8X_FIFO_LOG_MON0  = 0x%x\n", Ana_Get_Reg(AFE_UP8X_FIFO_LOG_MON0));
    len += seq_printf(buf+len , "AFE_UP8X_FIFO_LOG_MON1  = 0x%x\n", Ana_Get_Reg(AFE_UP8X_FIFO_LOG_MON1));
    len += seq_printf(buf+len , "AFE_PMIC_NEWIF_CFG0  = 0x%x\n", Ana_Get_Reg(AFE_PMIC_NEWIF_CFG0));
    len += seq_printf(buf+len , "AFE_PMIC_NEWIF_CFG1  = 0x%x\n", Ana_Get_Reg(AFE_PMIC_NEWIF_CFG1));
    len += seq_printf(buf+len , "AFE_PMIC_NEWIF_CFG2  = 0x%x\n", Ana_Get_Reg(AFE_PMIC_NEWIF_CFG2));
    len += seq_printf(buf+len , "AFE_PMIC_NEWIF_CFG3  = 0x%x\n", Ana_Get_Reg(AFE_PMIC_NEWIF_CFG3));

    len += seq_printf(buf+len , "AFE_TOP_PMIC_CON0  = 0x%x\n", Ana_Get_Reg(AFE_TOP_PMIC_CON0));
    len += seq_printf(buf+len , "ABB_MON_DEBUG0  = 0x%x\n", Ana_Get_Reg(ABB_MON_DEBUG0));

    len += seq_printf(buf+len , "TOP_CKPDN0  = 0x%x\n", Ana_Get_Reg(TOP_CKPDN0));
    len += seq_printf(buf+len , "TOP_CKPDN0_CLR  = 0x%x\n", Ana_Get_Reg(TOP_CKPDN0_CLR));
    len += seq_printf(buf+len , "TOP_CKPDN1  = 0x%x\n", Ana_Get_Reg(TOP_CKPDN1));
    len += seq_printf(buf+len , "TOP_CKCON1  = 0x%x\n", Ana_Get_Reg(TOP_CKCON1));

    len += seq_printf(buf+len , "SPK_CON0  = 0x%x\n", Ana_Get_Reg(SPK_CON0));
    len += seq_printf(buf+len , "SPK_CON1  = 0x%x\n", Ana_Get_Reg(SPK_CON1));
    len += seq_printf(buf+len , "SPK_CON2  = 0x%x\n", Ana_Get_Reg(SPK_CON2));
    len += seq_printf(buf+len , "SPK_CON6  = 0x%x\n", Ana_Get_Reg(SPK_CON6));
    len += seq_printf(buf+len , "SPK_CON7  = 0x%x\n", Ana_Get_Reg(SPK_CON7));
    len += seq_printf(buf+len , "SPK_CON8  = 0x%x\n", Ana_Get_Reg(SPK_CON8));
    len += seq_printf(buf+len , "SPK_CON9  = 0x%x\n", Ana_Get_Reg(SPK_CON9));
    len += seq_printf(buf+len , "SPK_CON10  = 0x%x\n", Ana_Get_Reg(SPK_CON10));
    len += seq_printf(buf+len , "SPK_CON11  = 0x%x\n", Ana_Get_Reg(SPK_CON11));
    len += seq_printf(buf+len , "SPK_CON12  = 0x%x\n", Ana_Get_Reg(SPK_CON12));

    len += seq_printf(buf+len , "AUDTOP_CON0  = 0x%x\n", Ana_Get_Reg(AUDTOP_CON0));
    len += seq_printf(buf+len , "AUDTOP_CON1  = 0x%x\n", Ana_Get_Reg(AUDTOP_CON1));
    len += seq_printf(buf+len , "AUDTOP_CON2  = 0x%x\n", Ana_Get_Reg(AUDTOP_CON2));
    len += seq_printf(buf+len , "AUDTOP_CON3  = 0x%x\n", Ana_Get_Reg(AUDTOP_CON3));
    len += seq_printf(buf+len , "AUDTOP_CON4  = 0x%x\n", Ana_Get_Reg(AUDTOP_CON4));
    len += seq_printf(buf+len , "AUDTOP_CON5  = 0x%x\n", Ana_Get_Reg(AUDTOP_CON5));
    len += seq_printf(buf+len , "AUDTOP_CON6  = 0x%x\n", Ana_Get_Reg(AUDTOP_CON6));
    len += seq_printf(buf+len , "AUDTOP_CON7  = 0x%x\n", Ana_Get_Reg(AUDTOP_CON7));
    len += seq_printf(buf+len , "AUDTOP_CON8  = 0x%x\n", Ana_Get_Reg(AUDTOP_CON8));
    len += seq_printf(buf+len , "AUDTOP_CON9  = 0x%x\n", Ana_Get_Reg(AUDTOP_CON9));
